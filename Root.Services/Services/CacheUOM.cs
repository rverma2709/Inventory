...
namespace Root.Services.Services
{
    ...
    public class CacheUOM : IDisposable
    {
       ...
       // private readonly ICacheService _cacheService;
        ...
        //}
        public CacheUOM( ICommonService commonService, IMemoryCache memoryCache)
        {
            _commonService = commonService;
        ...
        //public async Task<List<SFDDListResult>> StatusCodesList(bool update = false) { return await GetValuesAsync<SFDDListResult>(update); }
        ...
        //public async Task<List<ProcDetail>> ProcDetailsList(bool update = false) { return await GetValuesAsync<ProcDetail>(update); }
        public void Dispose()
        {
